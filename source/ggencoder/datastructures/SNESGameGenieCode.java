...
/**
 * An implementation of the GameGenieCode interface for SNES Game Genie
 * Codes.
 *
 * @author John David Ratliff
 * @version 1.1, 07/13/04
 */
class SNESGameGenieCode extends AbstractGameGenieCode {
    /**
     * Creates a new SNESGameGenieCode object. This method should never be
     * called directly except by AbstractGameGenieCode.snesParse(String).
     *
     * @param code The game genie code to encapsulate.
     */
    protected SNESGameGenieCode(String code) {
        this.setCode(code);
    }
     ...
     *
     * @return true if the code is a valid SNES game genie code, false
     *         otherwise.
     */
    ...
    public char[] getAlphabet() {
        return AbstractGameGenieCode.SNES_ALPHABET;
    }
    ...
    public String toString() {
        return "SNESGameGenieCode[" + this.getCode() + "]";
    }
}
