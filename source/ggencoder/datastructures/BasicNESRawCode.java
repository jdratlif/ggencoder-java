 ...
 */
public class BasicNESRawCode extends AbstractRawCode implements NESRawCode {
     ...
     */
    public BasicNESRawCode(int address, int value, int compare) {
        this(address, value);
    ...
    public String toString() {
        return "NESRawCode[" +
               ...
               (this.hasCompareValue()
                ? ("?" +
                this.toHexString(this.getCompareValue(), 2)) : "") +
               "]";
    }
}
